...
pub struct EguiState {
    ...
    /// The new size of the window, if it was requested to resize.
    #[serde(skip)]
    new_size: AtomicCell<Option<(u32, u32)>>,
...
impl EguiState {
    ...
    fn set_new_size(&self, new_size: (u32, u32)) {
        self.new_size.store(Some(new_size));
    }
}
